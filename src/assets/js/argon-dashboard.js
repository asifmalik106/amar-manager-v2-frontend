...
const mainIconNavbarSidenav = document.getElementById('mainIconNavbarSidenav');
...
if (mainIconNavbarSidenav) {
  mainIconNavbarSidenav.addEventListener("click", toggleSidenav);
}
...
function toggleSidenav() {
  if (body.classList.contains(className)) {
    ...
    setTimeout(function() {
      ...
      sidenav.classList.remove('sidebar-show');
    ...
    sidenav.classList.add('sidebar-show');
